...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference("Produit.count") do
      post produits_url, params: { produit: { description: @produit.description, nom: @produit.nom, prix: @produit.prix } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { description: @produit.description, nom: @produit.nom, prix: @produit.prix } }
